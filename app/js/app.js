...
app.config(function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, ASSETS){
	...
	$stateProvider.
		...
		//monitor view
		state('app.monitor-view', {
			url: '/monitor/view/:monitorId',
			templateUrl: appHelper.templatePath('tenant/ticket-monitoring'),
		...
		// 	resolve: {
		// 		permission: function(AuthService,$state){
		// 			return AuthService.permission([roles.superAdmin,roles.admin]);
		// 		}
		// 	}
		// }).
		...
		state('app.fos', {
			url: '/fos',
			templateUrl: appHelper.templatePath('FOS/index'),
		...
		state('app.fos-form', {
			url: '/fos/create',
			templateUrl: appHelper.templatePath('FOS/form'),
			controller: 'FOSController',
			resolve: {
				permission: function(AuthService, $state) {
                    return AuthService.permissionCheck([roles.superAdmin, roles.admin,roles.patient]);
		...
		state('app.fos-view', {
			url: '/fos/view/:fosId',
			templateUrl: appHelper.templatePath('FOS/view'),
			controller: 'FOSController',
			resolve: {
				permission: function(AuthService, $state) {
                    return AuthService.permissionCheck([roles.superAdmin, roles.admin,roles.patient]);
		...
		state('app.tenant-dashboard', {
			...
			templateUrl: appHelper.templatePath('tenant/tenant-dashboard'),
		}).

		// Vitals
		state('app.ticket-monitoring', {
			url: '/ticket-monitoring',
			templateUrl: appHelper.templatePath('tenant/ticket-monitoring'),
		}).
		//Vendors
		state('app.assignedtickets',{
			url:'/assignedtickets',
			templateUrl:appHelper.templatePath('vendor/assignedtickets'),
		}).

		// FOS Interaction
		state('app.fosInteraction', {
			url: '/fos-interaction',
			templateUrl: appHelper.templatePath('health-measures/fos-interaction'),
		}).
