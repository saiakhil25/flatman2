...
angular.module('xenon.services', []).
	service('$menuItems', function($rootScope)
	{
		...
		this.prepareSidebarMenu = function()
		{
			...
			if($rootScope.user.userRole == '0' || $rootScope.user.userRole == '1'|| $rootScope.user.userRole == '4'  || $rootScope.user.userRole == '5') {
				var users 		= this.addItem('Users', 	'/app/patients', 	'fa-user');
			}
